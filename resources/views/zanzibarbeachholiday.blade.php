    ...
    <div class="container-fluid py-6 wow bounceInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="text-center bg-light rounded p-5 border border-primary">
                <small class="d-inline-block fw-bold text-dark text-uppercase bg-white border border-primary rounded-pill px-4 py-1 mb-3">Plan Your Paradise Trip</small>
                <h2 class="display-5 mb-3">Ready to Start Your Zanzibar Adventure?</h2>
                <p class="lead mb-4 mx-auto" style="max-width: 600px;">Dreaming of Zanzibar? Tell us what you're looking for and our island experts will craft the perfect beach escape.</p>
