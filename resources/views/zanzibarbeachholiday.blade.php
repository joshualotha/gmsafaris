        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-1 d-none d-lg-block">
                    <img src="{{ asset('img/home-booking.webp') }}" class="img-fluid h-100 w-100 rounded-start" style="object-fit: cover; opacity: 0.7;" alt="Planning Zanzibar Holiday" loading="lazy">
                </div>
                    ...
                    <div class="border-bottom border-top border-primary bg-light py-5 px-4 h-100">
                        ...
                        <form id="zanzibarBeachForm" action="{{ route('inquiry.store') }}" method="POST">
                            ...
                            <div class="row g-3 form">
                                ...
                                <div class="col-12">
                                    <label for="zanzibarSubject" class="form-label small ms-1">Subject</label>
                                    <input type="text" class="form-control border-primary p-2" id="zanzibarSubject" name="subject" value="Zanzibar Beach Holiday Inquiry" placeholder="Subject">
                                </div>
                ...
                <div class="col-1 d-none d-lg-block">
                    <img src="{{ asset('img/home-booking.webp') }}" class="img-fluid h-100 w-100 rounded-end" style="object-fit: cover; opacity: 0.7;" alt="Planning Zanzibar Holiday" loading="lazy">
                </div>
            </div>
        </div>
    </div>
