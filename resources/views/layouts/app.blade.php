...
<head>
    ...
    <meta property="og:image" content="@yield('og_image', 'https://www.gmsafaris.co.tz/img/hero-1.jpg')">
    ...
    <meta name="twitter:image" content="@yield('twitter_image', 'https://www.gmsafaris.co.tz/img/hero-1.jpg')">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400;1,500&family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400&display=swap" rel="stylesheet">
