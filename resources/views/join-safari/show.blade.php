...
@section('content')
    <style>
        .page-header {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("{{ $joinSafari->hero_image ? asset('storage/' . $joinSafari->hero_image) : site_image('group_safari_hero') }}") center center no-repeat;
