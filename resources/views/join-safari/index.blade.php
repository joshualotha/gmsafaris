...
@section('content')
    <style>
        .page-header {
            background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("{{ site_image('group_safari_hero') }}") center center no-repeat;
                            ...
                            <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.1s">
                                <div class="safari-card rounded overflow-hidden h-100 d-flex flex-column">
                                    <div class="safari-img position-relative">
                                        <img src="{{ $joinSafari->hero_image ? asset('storage/' . $joinSafari->hero_image) : site_image('group_safari_hero') }}"
