...
@section('body_content')
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow bounceInUp" data-wow-delay="0.1s">
                 ...
                 <div class="col-lg-6 wow bounceInUp" data-wow-delay="0.3s">
                    <img src="{{ asset('img/budget-safari-main.jpg') }}" class="img-fluid rounded" alt="Travelers enjoying a budget safari in Tanzania" loading="lazy"> <!-- CHANGE IMAGE & ALT -->
                </div>
            </div>
            ...
            <div class="row g-4 mt-5 wow bounceInUp" data-wow-delay="0.1s">
             ...
             <div class="row g-5 mt-5 align-items-center">
                <div class="col-lg-6 wow bounceInUp" data-wow-delay="0.1s">
                    <img src="{{ asset('img/budget-camping.jpg') }}" class="img-fluid rounded" alt="Budget safari campsite setup in Tanzania" loading="lazy"> <!-- CHANGE IMAGE & ALT -->
                </div>
                <div class="col-lg-6 wow bounceInUp" data-wow-delay="0.3s">
    ...
    <!-- ======================= DETAILED BUDGET INQUIRY FORM START ========================== -->
    <div class="container-fluid contact py-6 wow bounceInUp" data-wow-delay="0.1s" id="inquire-budget"> <!-- Updated ID -->
        <div class="container">
            <div class="row g-0">
                <div class="col-1 d-none d-lg-block">
                    <img src="{{ asset('img/home-booking.jpg') }}" class="img-fluid h-100 w-100 rounded-start" style="object-fit: cover; opacity: 0.7;" alt="Planning Budget Safari" loading="lazy">
                </div>
                <div class="col-lg-10 col-md-12">
                    <div class="border-bottom border-top border-primary bg-light py-5 px-4 h-100">
                        <div class="text-center">
                            <small class="d-inline-block fw-bold text-dark text-uppercase bg-light border border-primary rounded-pill px-4 py-1 mb-3">Start Your Affordable Adventure</small> <!-- Updated Subtitle -->
                            <h1 class="display-5 mb-4">Inquire About Your Budget Safari</h1> <!-- Updated Heading -->
                        ...
                        <form action="{{ route('inquiry.store') }}" method="POST">
                            ...
                            <div class="row g-3 form">
                                ...
                                <input type="hidden" name="subject" value="Budget Safari Inquiry">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" class="btn btn-primary px-5 py-3 rounded-pill">Get My Budget Safari Quote</button> <!-- Button Text Updated -->
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-1 d-none d-lg-block">
                    <img src="{{ asset('img/home-booking.jpg') }}" class="img-fluid h-100 w-100 rounded-end" style="object-fit: cover; opacity: 0.7;" alt="Planning Budget Safari" loading="lazy">
                </div>
            </div>
        </div>
    </div>
