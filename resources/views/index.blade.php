    ...
    <div class="container">
        ...
        <div class="owl-carousel owl-theme testimonial-carousel testimonial-carousel-1 mb-4 wow bounceInUp"
            ...
            <div class="testimonial-item rounded bg-light">
                <div class="d-flex mb-3">
                    <img src="{{ asset('img/Erlend G.webp') }}" class="img-fluid rounded-circle flex-shrink-0" alt="Traveler Erlend G from USA"
            ...
            <div class="testimonial-item rounded bg-light">
                <div class="d-flex mb-3">
                    <img src="{{ asset('img/misssunshine.webp') }}" class="img-fluid rounded-circle flex-shrink-0" alt="Traveler Miss Sunshine from Germany"
                        width="80" height="80" loading="lazy">
                    <div class="position-absolute" style="top: 15px; right: 20px;">
                        <i class="fa fa-quote-right fa-2x"></i>
                    </div>
            ...
            <div class="testimonial-item rounded bg-light">
                <div class="d-flex mb-3">
                    <img src="{{ asset('img/Monika U.webp') }}" class="img-fluid rounded-circle flex-shrink-0" alt="Traveler Monika U from Italy"
                        width="80" height="80" loading="lazy">
                    <div class="position-absolute" style="top: 15px; right: 20px;">
                        <i class="fa fa-quote-right fa-2x"></i>
                    </div>
