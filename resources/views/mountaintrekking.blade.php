            ...
            <div class="row g-0">
                ...
                <div class="col-lg-10 col-md-12">
                    <div class="border-bottom border-top border-primary bg-light py-5 px-4 h-100">
                        ...
                        <form id="trekForm" action="{{ route('inquiry.store') }}" method="POST">
                            @csrf
                            <div class="row g-3 form">
                                ...
                                <input type="hidden" name="subject" value="Mountain Trekking Inquiry">
                                ...
                                <!-- Detailed Request -->
                                 <div class="col-12 mt-3">
                                    ...
                                    <textarea class="form-control border-primary p-2" id="trekDetails" name="message" rows="6" placeholder="Please describe your previous trekking experience (if any), general fitness level, preferred route if 'Other', any specific dates, equipment rental needs, dietary requirements, or other questions." required></textarea>
                                </div>
