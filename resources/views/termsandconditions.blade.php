...
<style>
            ...
            .page-header {
                ...
                background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(img/1659143707.jpg) center center no-repeat;
...

    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.gmsafaris.co.tz/termsandconditions"
        }
      ]
    }
    </script>
