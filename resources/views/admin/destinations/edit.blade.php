...
@section('page_title', 'Edit Destination: ' . $destination->name)
        ...
        <form action="{{ route('admin.destinations.update', $destination) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="location" class="form-control" value="{{ old('location', $destination->location) }}" placeholder="e.g. Arusha, Tanzania">
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="subtitle" class="form-control" value="{{ old('subtitle', $destination->subtitle) }}" placeholder="e.g. The Endless Plains & Great Migration">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Badge Text</label>
                            <input type="text" name="badge_text" class="form-control" value="{{ old('badge_text', $destination->badge_text) }}" placeholder="e.g. Africa's Iconic Wilderness">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-select">
                                ...
                                <option value="National Park" @selected(old('category', $destination->category) == 'National Park')>National Park</option>
                                <option value="Mountain" @selected(old('category', $destination->category) == 'Mountain')>Mountain</option>
                                <option value="Lake" @selected(old('category', $destination->category) == 'Lake')>Lake</option>
                                <option value="Attraction" @selected(old('category', $destination->category) == 'Attraction')>Attraction</option>
                                <option value="Conservation Area" @selected(old('category', $destination->category) == 'Conservation Area')>Conservation Area</option>
                                <option value="Wildlife Experience" @selected(old('category', $destination->category) == 'Wildlife Experience')>Wildlife Experience</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="key_attractions" class="form-control" value="{{ old('key_attractions', $destination->key_attractions) }}" placeholder="e.g. Great Migration, Big Five">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card mb-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="short_description" class="form-control" rows="3" placeholder="Brief summary for listing cards">{{ old('short_description', $destination->short_description) }}</textarea>
                </div>

                <div class="mb-3">
                    <label class="form-label">Full Description</label>
                    <textarea name="description" class="form-control" rows="8" placeholder="Main content - first paragraph">{{ old('description', $destination->description) }}</textarea>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="cta_text" class="form-control" value="{{ old('cta_text', $destination->cta_text) }}" placeholder="e.g. Plan Your Serengeti Adventure">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">CTA Anchor URL</label>
                            <input type="text" name="cta_url" class="form-control" value="{{ old('cta_url', $destination->cta_url) }}" placeholder="e.g. #inquire-serengeti">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($destination->hero_image)
                                <div class="mb-2"><img src="{{ \App\Models\Destination::resolveImageUrl($destination->hero_image) }}" class="img-preview" alt="{{ $destination->name }} hero image" loading="lazy"></div>
                            @endif
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            @if($destination->thumbnail_image)
                                <div class="mb-2"><img src="{{ \App\Models\Destination::resolveImageUrl($destination->thumbnail_image) }}" class="img-preview" alt="{{ $destination->name }} thumbnail" loading="lazy"></div>
                            @endif
                    ...
                    @if($destination->gallery_images)
                        <div class="mt-2 d-flex gap-2 flex-wrap">
                            @foreach($destination->gallery_images as $img)
                                <img src="{{ \App\Models\Destination::resolveImageUrl($img) }}" class="img-preview" style="width:100px;height:75px;" alt="{{ $destination->name }} gallery image" loading="lazy">
                            @endforeach
                        </div>
                    @endif
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="map_embed_url" class="form-control" value="{{ old('map_embed_url', $destination->map_embed_url) }}" placeholder="Google Maps embed iframe src URL">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Video URL</label>
                            <input type="text" name="video_url" class="form-control" value="{{ old('video_url', $destination->video_url) }}" placeholder="YouTube or Vimeo URL">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card mb-4">
                ...
                <div id="features-container">
                    @php
                        $features = old('features', $destination->features ?? []);
                    @endphp
            ...
            <div class="section-card mb-4">
                ...
                <div id="wildlife-container">
                    @php
                        $wildlife = old('wildlife_highlights', $destination->wildlife_highlights ?? []);
                    @endphp
                    @foreach($wildlife as $index => $item)
            ...
            <div class="section-card mb-4">
                ...
                <div id="activities-container">
                    @php
                        $activities = old('activities', $destination->activities ?? []);
                    @endphp
            ...
            <div class="section-card mb-4">
                ...
                @php
                    $btv = old('best_time_to_visit', $destination->best_time_to_visit ?? []);
                    $dryTitle = $btv['dry_season']['title'] ?? 'Dry Season (June - October)';
                    $dryItems = $btv['dry_season']['items'] ?? [];
                    $wetTitle = $btv['wet_season']['title'] ?? 'Wet / Green Season (November - May)';
                    $wetItems = $btv['wet_season']['items'] ?? [];
                @endphp
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="best_time_to_visit[dry_season][title]" class="form-control form-control-sm" value="{{ $dryTitle }}">
                            </div>
                            <label class="form-label small">Bullet Points</label>
                            <div id="dry-season-items">
                                @foreach($dryItems as $item)
                                    <div class="input-group mb-2">
                    ...
                    <div class="col-md-6">
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="mb-3">
                                <label class="form-label small">Section Title</label>
                                <input type="text" name="best_time_to_visit[wet_season][title]" class="form-control form-control-sm" value="{{ $wetTitle }}">
                            </div>
                            <label class="form-label small">Bullet Points</label>
                            <div id="wet-season-items">
                                @foreach($wetItems as $item)
                                    <div class="input-group mb-2">
            ...
            <div class="section-card mb-4">
                ...
                <div id="quick-facts-container">
                    @php
                        $quickFacts = old('quick_facts', $destination->quick_facts ?? []);
                    @endphp
                    @foreach($quickFacts as $qf)
                        <div class="input-group mb-2">
                ...
                <div class="mb-3">
                    <select name="related_destinations[]" class="form-select" multiple>
                        @php
                            ...
                            $selectedIds = old('related_destinations', $destination->related_destinations ?? []);
                        @endphp
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="seo_title" class="form-control" value="{{ old('seo_title', $destination->seo_title) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">SEO Description</label>
                            <textarea name="seo_description" class="form-control" rows="2">{{ old('seo_description', $destination->seo_description) }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">SEO Keywords</label>
                            <input type="text" name="seo_keywords" class="form-control" value="{{ old('seo_keywords', $destination->seo_keywords) }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="sort_order" class="form-control" value="{{ old('sort_order', $destination->sort_order) }}" min="0">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between mt-4">
                ...
                <button type="submit" class="btn btn-gold"><i class="fas fa-save me-1"></i> Update Destination</button>
            </div>
        </form>
    </div>
@endsection
...
<script>
    ...
    let featureIndex = {{ $features ? count($features) : 0 }};
    function addFeature() {
    ...
    let wildlifeIndex = {{ $wildlife ? count($wildlife) : 0 }};
    ...
    let activityIndex = {{ $activities ? count($activities) : 0 }};
    ...
    // FAQ (question, answer)
    let faqIndex = {{ $faqs ? count($faqs) : 0 }};
    function addFaq() {
