            ...
            .privacy-content h3 {
             ...
             .py-6 {
                 ...
                 padding-bottom: 6rem;
                         ...
                         /* Page Header Style */
            .page-header {
                /* *** Consider a neutral or abstract hero image for this page (e.g., img/privacy-hero.jpg) *** */
                background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(img/bhavani-privacy-policy-banner.jpg) center center no-repeat;
...

    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Privacy Policy",
          "item": "https://www.gmsafaris.co.tz/privacypolicy"
        }
      ]
    }
    </script>
