<?php
/**
 * Phase 4 Content Production — Batch 1 of 3
 * Creates 4 cluster articles for the remaining topical clusters
 * 
 * Posts to create:
...
function makeContent($html, $safarisUrl, $blogBaseUrl) {
    return str_replace(
        ['SAFARIS_URL', 'BLOG_BASE_URL'],
        [$safarisUrl, $blogBaseUrl],
        $html
    );
}
...
// ============================================================
// POST 14: What to Pack for a Tanzania Safari
// ============================================================
$post14_html = '
...
<li><strong>Visa</strong> — e-Visa or visa on arrival (see our Tanzania visa guide)</li>
...
$post14 = [
    ...
    'content' => makeContent($post14_html, $safarisUrl, $blogBaseUrl),
...
// ============================================================
// POST 15: Best Time to Visit Serengeti National Park
// ============================================================
$post15_html = '
...
<h2>Serengeti vs Ngorongoro: When to Visit Each</h2>
<p>While the Serengeti has seasonal variations, the nearby Ngorongoro Crater offers excellent wildlife viewing year-round due to the permanent water supply. Many itineraries combine both — the Serengeti for the migration and Ngorongoro for guaranteed wildlife viewing regardless of season.</p>
...
$post15 = [
    ...
    'content' => makeContent($post15_html, $safarisUrl, $blogBaseUrl),
...
// ============================================================
// POST 16: Best Time to Climb Kilimanjaro
// ============================================================
$post16_html = '
...
$post16 = [
    ...
    'slug' => 'best-time-to-climb-kilimanjaro-season